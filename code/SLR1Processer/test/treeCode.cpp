...
int main() {
    ...
    ifstream file("/home/ice/code/cpp/daliangbyyl/daliangbyyl/Compiler-Principles-Project/code/SLR1Processer/test/SLR1Str.txt");
    stringstream buffer;
    buffer << file.rdbuf();
    ...
    vector<KeyValue> keyValuePairs = readKeyValuePairs("/home/ice/code/cpp/daliangbyyl/daliangbyyl/Compiler-Principles-Project/code/SLR1Processer/test/output.lex");
    ...
    ofstream outFile("/home/ice/code/cpp/daliangbyyl/daliangbyyl/Compiler-Principles-Project/code/SLR1Processer/test/tree.out");
    if (outFile.is_open())
    {
        outFile << str;
        outFile.close();
