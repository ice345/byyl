...
int main() {
    ...
    ifstream file("/home/ice/code/cpp/daliangbyyl/daliangbyyl/Compiler-Principles-Project/code/SLR1Str.txt");
    stringstream buffer;
    buffer << file.rdbuf();
    ...
    vector<KeyValue> keyValuePairs = readKeyValuePairs("/home/ice/code/cpp/daliangbyyl/daliangbyyl/Compiler-Principles-Project/code/SLR1Processer/sample_miniC.lex");
    ...
    istringstream iss(str);
    ofstream outFile("/home/ice/code/cpp/daliangbyyl/daliangbyyl/Compiler-Principles-Project/code/tree.out");
    if (outFile.is_open())
    {
        outFile << str;
        outFile.close();
